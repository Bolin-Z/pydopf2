...
%   Author:C. Zeng
%   Time:5.11.2021
%   Function:Ϊ������OPF����ģ�ͣ�����ϵͳ��4�Žڵ���IEEE-30�ڵ�ϵͳ��3�Žڵ������ӣ�
%            ��4�Žڵ�������һ��10�Žڵ㿴����IEEE-30�ڵ�ϵͳ��3�Žڵ㡣
...
mpc.bus = [
    ...
    10	1	0	0	0	0	1	1	0	345	1	1.1	0.9; %�����ڵ�
];
...
mpc.branch = [
    ...
    4	10	0.053	0.057	0.00	250	250	250	0	0	1	-360	360; %������4-10(3)
