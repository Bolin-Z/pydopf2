...
%   Author:C. Zeng
%   Time:5.11.2021
%   Function:Ϊ������OPF����ģ�ͣ�����ϵͳ��3�Žڵ���IEEE-9�ڵ�ϵͳ��4�Žڵ������ӣ�
%            ��3�Žڵ�������һ��31�Žڵ㿴����IEEE-9�ڵ�ϵͳ��4�Žڵ㡣
...
mpc.bus = [
    ...
    31	1	0	0	0	0	1	0.992	-17.94	132	1	1.10	0.90; %�����ڵ�
];
...
mpc.branch = [
    ...
    3	31	0.053	0.057	0.00	0	0	0	0	0	1	-360	360; %������3-31(4)
